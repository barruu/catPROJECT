...
class irGetCMD(object):
    def __init__(self, gpioNum):
        ...
        Args:
        - gpioNum: GPIO pin number to which the IR receiver is connected.
        """
    ...
    def __logHandler(self, source):
        """
        Handler function for logging IR pulses.
        """
    ...
    def ir_read(self):
        """
        Read the IR signal and decode it.

        Returns:
        - Hexadecimal value representing the IR command.
        """
        utime.sleep_ms(200) 
        if utime.ticks_diff(
                utime.ticks_us(),
